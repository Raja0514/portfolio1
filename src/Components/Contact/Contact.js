                ...
                <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
                    <div className="py-6 md:py-0 md:px-6">
                        ...
                        <div className='flex my-5 items-center gap-5 flex-wrap'>
                            <div className='bg-gray-50 p-2 w-14 h-12 rounded-lg hover:duration-500 hover:bg-gray-600 hover:text-gray-50 hover:scale-110'><a data-aos="zoom-in" data-aos-delay="100" data-aos-duration="1000" href='https://github.com/Raja0514' target="_blank" rel='noreferrer'><BsGithub className='w-full h-full ' /></a></div>
                            <div className='bg-gray-50 p-2 w-14 h-12 rounded-lg hover:duration-500 hover:bg-gray-600 hover:text-gray-50 hover:scale-110'>
                                <a data-aos="zoom-in" data-aos-delay="400" data-aos-duration="1000" href='https://www.facebook.com/raja.mathiyazhagan' target="_blank" rel='noreferrer'><BsFacebook className='w-full h-full ' /></a>
                            </div>
                            <div className='bg-gray-50 p-2 w-14 h-12 rounded-lg hover:duration-500 hover:bg-gray-600 hover:text-gray-50 hover:scale-110'>
                                <a data-aos="zoom-in" data-aos-delay="700" data-aos-duration="1000" href="https://www.linkedin.com/feed/
                        ...
                        <div className="space-y-4 mt-5">
                            ...
                            <p className="flex items-center">
                                ...
                                <span>rajamr1987@gmail.com</span>
                            </p>
                        </div>
                    </div>
                    <div>
