...
const ProjectCard = ({ projects }) => {
    ...
    return (
        <motion.div
            ...
            className='flex flex-col justify-center items-center mt-7 w-full bg-gray-100 md:p-10 p-2 rounded-lg' style={{border:"2px solid red"}}>
               
            {
                projects?.map(project => <div key={project.id} className={`flex ${project.id % 2 === 0 ? 'lg:flex-row flex-col' : 'lg:flex-row-reverse flex-col'} justify-center items-center md:gap-10 gap-10 w-full`} style={{border:"2px solid blue",margin:"20px"}}>


                    <div className="flex flex-col lg:w-[40%] w-full md:p-6 p-3 md:space-y-6 space-y-1 overflow-hidden rounded-lg shadow-md bg-gray-900 bg-gradient-to-tl from-gray-600 text-gray-100" style={{border:"2px solid red"}}>
                    ...
                    <div className='text-lg text-gray-700 lg:w-[60%] w-full lg:mb-0 mb-5' style={{border:"2px solid red"}}>
